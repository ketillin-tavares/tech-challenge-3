...
class TokenVerifier(ABC):
    ...
    Implementado por um adapter de infraestrutura (validacao via JWKS do
    Cognito, mesmo padrao do servico de vendas). Converte um token opaco em
    uma identidade de dominio.
    """
